...
- **[Brumora](https://brumora.app)** — commercial Windows app, live on the Microsoft
  Store. Byte-for-byte verification before any delete, operation journaling with
  rollback, crash and power-cut recovery. Sole engineer for the app, the site and
  the release pipeline.
- **Volna** — production backend for an AI product, currently closed beta.
